...
### Авторы
[`Архипов Владимир`](https://t.me/V_arkh "ТГ") - parser, streamlit and GPT API

[`Линьков Вадим`](https://github.com/trizyx "Github") - voice optimization and design 

[`Щерба Матвей`](https://github.com/SNex21 "Github") - Fast API and llama

[`Кирилл Клем`](https://github.com/KirillKlem "Github") - llama and research

[`Полина Матренок`](https://github.com/Polina-Matrenok "Github") - design and research
